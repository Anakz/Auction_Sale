<div style="width: 100%;height: 80px; background-color: black;padding-right: 40px;padding-top: 20px;">
      <h1 id="logo"><img src="{{ asset('assets/image/logo.png')  }}" style="height:95% ; width: 100%;padding-left: 50px;"></h1>
                    ...
                    <ul class="nav justify-content-end">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                <a id="nav-link dropdown-toggle" style="color: white" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
