...
<div class="img" style="background-image:url(assets/image/ttt.png)">
</div>
...
<label class="label" for="name">Adress Mail</label>
...
<script src="{{ asset('assets/js/Ymain')  }}"></script> 
<script src="{{ asset('assets/js/Ypopper')  }}"></script>