...
@section('content')
<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/Ystyles.css') }}">
                        ...
                        <p>
                                        ...
                                        <strong>Categorie:</strong>  
                                                        ...
                                                        @if( ($article->categorie_id) == 2 )
                                                            Véhicule
                                                        @endif
                                                        @if( ($article->categorie_id) ==3 )                                                          Materiels et Meubles
                                                        @endif
...
<script src="{{ asset('assets/js/Yscripts.js')  }}"></script> 
@endsection