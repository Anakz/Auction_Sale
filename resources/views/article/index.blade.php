						...
						<div class="items">
							...
							<ul>
							    <li>
							    	...
							    	<p>
							    		<b>Libele:</b> <span>{{ $article->libele }}</span><br>
							    		<b>Date de fin :</b> <span>{{ $article->date_echeance }}</span><br>
							    		<b>Categorie:</b>  <a href="">
							    						@if( ($article->categorie_id) == 1 )
							    							Bijoux et Accessoire
							    						@endif
							    						@if( ($article->categorie_id) == 2 )
							    							Véhicule
							    						@endif
							    						@if( ($article->categorie_id) == 3 )
							    							Materiels et Meubles
							    						@endif
							    						@if( ($article->categorie_id) == 4 )
							    							Sport
							    						@endif
							    					</a>
							    	</p>
							    	<p class="price">
							    		<b>Prix</b>: <strong>{{ $article->prix_seuil }} MAD</strong>
							    	</p>
						...
						<div class="items">
							...
							<ul>
							    <li>
							    	...
							    	<p>
										<b><h6 class="center-text" style="border:1px dotted black;color: grey">Produit expiré</h6></b>
									</p>
